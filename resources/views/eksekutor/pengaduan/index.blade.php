...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('eksekutor.pengaduan.index') }}" class="mb-4">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('eksekutor.pengaduan.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Daftar Pengaduan yang Ditugaskan</h6>
        </div>
        <div class="card-body">
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $item->pengguna->nama_lengkap ?? $item->pengguna->username }}<br>
                                ...
                                <td>
                                    @if($item->penugasan->count())
                                        {{ $item->penugasan->first()->tanggal_penugasan->format('d/m/Y') }}
                                    @else
                                        <span class="text-muted">-</span>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('eksekutor.pengaduan.show', $item->id) }}" 
                                       class="btn btn-sm btn-outline-primary" title="Lihat Detail & Kelola">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    @if(in_array($item->status, ['baru', 'diproses']))
                                        <a href="{{ route('eksekutor.tindak-lanjut.create', ['pengaduan_id' => $item->id]) }}" 
                                           class="btn btn-sm btn-outline-success" title="Tambah Tindak Lanjut">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h5 class="text-gray-600">Tidak Ada Penugasan</h5>
