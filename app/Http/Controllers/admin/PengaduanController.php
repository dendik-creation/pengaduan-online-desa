...
class PengaduanController extends Controller
{
    ...
    public function show(Pengaduan $pengaduan)
    {
        ...
        $eksekutorList = User::where("role", "eksekutor")
    ...
    public function edit(Pengaduan $pengaduan)
    {
        ...
        return view(
            ...
            compact("pengaduan", "title", "categories"),
        );
    }
    ...
    public function assignEksekutor(Pengaduan $pengaduan, Request $request)
    {
        ...
        $eksekutor = User::where("id", $validated["eksekutor_id"])
            ->where("role", "eksekutor")
            ->first();
        if (!$eksekutor) {
        ...
        if ($exists) {
            return back()->with(
                "error",
                "Eksekutor sudah ditugaskan untuk pengaduan ini.",
            );
        }
        Penugasan::create([
